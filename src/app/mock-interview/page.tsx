                ...
                <Card className="bg-card/50 border-border/10 shadow-lg">
                    <CardHeader className="text-center p-8">
                        ...
                        <CardDescription className="text-lg pt-2 max-w-2xl mx-auto">
                            Prepare to ace your technical interviews with a realistic, personalized mock interview session.
                        </CardDescription>
                    </CardHeader>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <ul className="space-y-3 text-muted-foreground">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span>Realistic technical interview simulation (DSA & System Design).</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                                    <span>In-depth feedback on problem-solving and communication.</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                    ...
                    <CardFooter className="flex-col gap-4 p-8 border-t border-border/10 mt-8">
                        <Button asChild size="lg" className="w-full max-w-xs">
                           <Link href="mailto:princekr2840@gmail.com?subject=Mock%20Interview%20Session%20Booking">
